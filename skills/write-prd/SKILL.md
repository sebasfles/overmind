...
name: write-prd
description: >-
  Write or update the Product Requirements Document: the general docs/PRD.md (what the product is,
  for whom, its modules as capabilities) and per-module prd.md (what the module does for the user and
  why). No engineering detail. Sources: an overview document, designs, the code's user-facing surface.
  Edits in place. Used by setup; manager scope.
